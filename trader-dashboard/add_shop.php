...
if(isset($_POST['submit']))
{
       ...
       if(shop_quantity($connection) == true)
       {
        ...
        if(!empty($shopname))
        {
            ...
            if(!empty($registration))
            {
             ...
             $status = '0';
             $sql = "insert into shop (shop_name,shop_location,shop_registration_no,status,fk1_user_id,logo)
 ...
 <p>Click here to activate your account : http://localhost/loginregister/trader-dashboard/shop_activation.php?approve=$approval&reg=$registration</p>
