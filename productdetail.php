...
<head>
    ...
    if(!empty($_GET["id"]))
    {
     ...
     if(oci_execute($result))
     {
       while(($row = oci_fetch_assoc($result))!= false)
       {
        ...
        $allergy = $row["PRODUCT_ALLERGY_INFO"];
        $shop_id = $row["FK1_SHOP_ID"];
       }
     }
  }
  $_SESSION['id'] =$id;
  ...
  if(isset($_POST["review"]))
  {
   ...
   $query = "insert into review (REVIEW_COMMENT,REVIEW_RATING,REVIEW_DATE,FK1_PRODUCT_ID,FK2_USER_ID)
    ...
    <div class="row">
      ...
      <div class="offset-2 col-md-4">
        <div class="productimage-detail">
          <img class="img-fluid" src="images/<?php echo$image;?>" alt="" id="productimage-detail">
        </div>
        <!-- end of image here -->
      </div>
          ...
          <div class="row">
            <div class="col-1" style="padding: 0px; margin-right: 35px;">
              <div class="quantitypd">
                <input id="quantity" type="number" value="<?php echo $minimun;?>" class="form-control quantity-input" style="width:65px;">
              </div>
            </div>
            <div class="col-6" style="margin: 0px; padding: 0px; display: inline-block;">
              <a href="add_to_cart.php?id=<?php echo $id;?>&page=productdetail.php"><button type="button" class="btn btn-outline-success" style="display: inline-block;">Add to Cart</button></a>
              <a href="add_to_wishlist.php?id=<?php echo $id;?>&page=productdetail.php"><button type="button" class="btn" style="margin-left:10px; border-style: solid; border-color: green;">  <img src="images/icons/heart3.png" alt="" srcset="">
              </button></a>
                  ...
                  <tbody>
                      ...
                      <td class="progress-bar-container">
                        <div class="fit-progressbar fit-progressbar-bar star-progress-bar">
                          <div class="fit-progressbar-background">
                            <span class="progress-fill" style="width: <?php if(get_rating_count($connection,$id) == 0){echo "0";} else{ echo ((get_5star_rating($connection,$id)/get_rating_count($connection,$id))*100);} ?>%;"></span>
                          </div>
                        </div>
                      </td>
                    ...
                    <tr class="">
                      ...
                      <td class="progress-bar-container">
                        <div class="fit-progressbar fit-progressbar-bar star-progress-bar">
                          <div class="fit-progressbar-background">
                            <span class="progress-fill" style="width: <?php if(get_rating_count($connection,$id) == 0){echo "0";} else{ echo(( get_4star_rating($connection,$id)/get_rating_count($connection,$id))*100);} ?>%;"></span>
                          </div>
                        </div>
                      </td>
                    ...
                    <tr class="">
                      ...
                      <td class="progress-bar-container">
                        <div class="fit-progressbar fit-progressbar-bar star-progress-bar">
                          <div class="fit-progressbar-background">
                            <span class="progress-fill" style="width: <?php if(get_rating_count($connection,$id) == 0){echo "0";} else{ echo(( get_3star_rating($connection,$id)/get_rating_count($connection,$id))*100);} ?>%;"></span>
                          </div>
                        </div>
                      </td>
                    ...
                    <tr class="">
                      ...
                      <td class="progress-bar-container">
                        <div class="fit-progressbar fit-progressbar-bar star-progress-bar">
                          <div class="fit-progressbar-background">
                            <span class="progress-fill" style="width: <?php if(get_rating_count($connection,$id) == 0){echo "0";} else{ echo(( get_2star_rating($connection,$id)/get_rating_count($connection,$id))*100);} ?>%;"></span>
                          </div>
                        </div>
                      </td>
                    ...
                    <tr class="">
                      ...
                      <td class="progress-bar-container">
                        <div class="fit-progressbar fit-progressbar-bar star-progress-bar">
                          <div class="fit-progressbar-background">
                            <span class="progress-fill" style="width: <?php if(get_rating_count($connection,$id) == 0){echo "0";} else{ echo(( get_1star_rating($connection,$id)/get_rating_count($connection,$id))*100);} ?>%;"></span>
                          </div>
                        </div>
                      </td>
     ...
     ?>
      ...
      <div class="col-md-3">
        ...
        <div class="vendorimage">
          <img src="images/vendors/<?php echo $logo;?>" alt="<?php echo $shop_id;?>" srcset="" style="height:100px; width:100px;">
        </div>
      </div>
    </div>
  </div>
            ...
            <div class="review">
              <div class="comment-section">
               ...
               if(isset($_SESSION['user_id']))
               {
                  ...
                  $query = "select * from payment where FK2_USER_ID=$uid";
                  $result = oci_parse($connection,$query);
                  $count = 0;
                  if(oci_execute($result))
                  {
               ...
               ?>
                ...
                <!-- modal for when a user is not logged in -->
                ...
                <!-- modal if customer has not bought the product -->
                        ...
                        <form method="post" action="productdetail.php">
                          ...
                          <div class="star-rating js-star-rating" style="margin-top:0px; margin-bottom: 0px;">
                            ...
                            <input class="star-rating__input" type="radio" name="rating" value="5"><i
                              class="star-rating__star"></i>
                            <div class="current-rating current-rating--3-5 js-current-rating"><i
                                class="star-rating__star">AAA</i></div>
                          </div>
                ...
                <br>
                  <?php
                    $query = "select * from review where FK1_PRODUCT_ID =$id order by REVIEW_ID asc";
                    $result = oci_parse($connection,$query);
                    if(oci_execute($result))
                    {
                      while(($row = oci_fetch_assoc($result))!=false)
                     ...
                     $username = get_customer_name($connection,$row["FK2_USER_ID"]);
                     
                ?>
                <div class="media media-review">
                  <div class="media-user"><img src="images/dummy.png" alt=""></div>
                  <div class="media-body">
                    ...
                    <br>
                    <div class="description"><?php echo $row["REVIEW_COMMENT"]; ?> </div>
                  </div>
                </div>
                <?php
                  }
  ...
  <div class="container d-flex justify-content-center mt-100">
    <div class="row" style="margin-left:80px;">
      ...
      <?php
       ...
       $query = "select * from  (select * from product where PRODUCT_STATUS ='1' and PRODUCT_ID != $id and FK2_PRODUCT_CATEGORY_ID =$Category_id ) where ROWNUM <= 4";
       $result = oci_parse($connection,$query);
       if(oci_execute($result))
       {
          while(($row = oci_fetch_assoc($result )) != false)
          ...
          <div class="product-img"> <a href="productdetail.php?id=<?php echo $product_id;?>" data-abc="true"> <img src="images/<?php echo $image;?>" alt="">
            ...
            <div class="product-action">
              <div class="product-action-style">
                <a href="add_to_wishlist.php?id=<?php echo $product_id ; ?>&page=productdetail.php"> <img src="images/icons/heart.png" alt="" srcset=""> </a>

                <a href="add_to_cart.php?id=<?php echo $product_id ; ?>&page=productdetail.php"> <img src="images/icons/shopping-bag.png" alt="" srcset=""> </a>
