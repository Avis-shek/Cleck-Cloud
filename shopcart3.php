...
if(isset($_POST["update"]))
{
  ...
  $query = "update CART_PRODUCT set PRODUCT_QUANTITY = $quantity where FK1_PRODUCT_ID = $product_id and FK2_USER_ID=$user_id and purchase=0";
  ...
  <div class="shopping-cart">
    ...
    <div class="product">
      ...
      <div class="product-quantity">
        ...
        <button type="submit" name="update"><i class='fa-solid fa-rotate-right'></i></button>
